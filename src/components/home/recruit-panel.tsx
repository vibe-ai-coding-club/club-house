...
/**
 * 운영진 상시 모집 패널.
 * Meet Us와 같은 흰 배경·제목 스케일로, 중앙 정렬 CTA를 배치한다.
 */
  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col items-center gap-8 text-center">
      <motion.h2
        ...
        className="max-w-2xl text-3xl font-bold leading-[1.15] tracking-tight text-foreground sm:text-4xl"
      >
        하고 싶은 게 있다면,
        <br />
        같이 만들어가요
      ...
      >
        ...
        <Button asChild variant="outline" size="cta" className="rounded-none border-0 shadow-none">
          <a
