...
export const events: ClubEvent[] = [
  ...
  },
  {
    ...
    summary:
      '바이브 코드 러시는 한 달에 한 번 모여 각자 만들고 싶은 것을 바이브코딩하는 정기 모임입니다. 함께 있는 것만으로 몰입이 되는 시간을 만듭니다.',
    info: [
      { label: '형태', value: '정기 코딩 모임' },
      { label: '주기', value: '월 1회' },
      { label: '진행 장소', value: 'TBD' },
    ],
    sections: [
      {
        heading: '이런 행사예요',
        body: [
          '각자 원하는 프로젝트를 가져와 같은 공간에서 집중해 코딩하는 모임입니다.',
          '혼자서는 미루게 되는 작업도, 함께 모이면 끝까지 밀어붙이게 됩니다.',
        ],
      },
      {
        heading: '진행 방식',
        body: [
          '월 1회 정기적으로 진행합니다. 구체적인 일정과 장소는 매월 Discord에서 안내합니다.',
        ],
      },
    ],
    cta: {
